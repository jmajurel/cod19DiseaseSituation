...
http POST $API_URL timeStamp='5/17/2020, 10:00:00 AM' activeCase:=4525497 newCase:=100012 totalDeaths:=307395 newDeaths:=5336 
http POST $API_URL timeStamp='5/16/2020, 10:00:00 AM' activeCase:=4425485 newCase:=86827 totalDeaths:=302059 newDeaths:=4940 
http POST $API_URL timeStamp='5/15/2020, 10:00:00 AM' activeCase:=4338658 newCase:=90269 totalDeaths:=297119 newDeaths:=5073 
http POST $API_URL timeStamp='5/14/2020, 10:00:00 AM' activeCase:=4248389 newCase:=77965 totalDeaths:=292046 newDeaths:=4647 
#http POST $API_URL timeStamp='5/13/2020, 10:00:00 AM' activeCase:=4170424 newCase:=81577 totalDeaths:=287399 newDeaths:=4245 
#http POST $API_URL timeStamp='5/12/2020, 10:00:00 AM' activeCase:=4088848 newCase:=82591 totalDeaths:=283153 newDeaths:=4261 
#http POST $API_URL timeStamp='5/11/2020, 10:00:00 AM' activeCase:=4006257 newCase:=88891 totalDeaths:=278892 newDeaths:=4531 
#http POST $API_URL timeStamp='5/10/2020, 10:00:00 AM' activeCase:=3917366 newCase:=61578 totalDeaths:=274361 newDeaths:=8499 
#http POST $API_URL timeStamp='5/09/2020, 10:00:00 AM' activeCase:=3855812 newCase:=95845 totalDeaths:=265862 newDeaths:=6388 
#http POST $API_URL timeStamp='5/08/2020, 10:00:00 AM' activeCase:=3759967 newCase:=87729 totalDeaths:=259474 newDeaths:=5429 
#http POST $API_URL timeStamp='5/07/2020, 10:00:00 AM' activeCase:=3672238 newCase:=83465 totalDeaths:=254045 newDeaths:=6539 
#http POST $API_URL timeStamp='5/06/2020, 10:00:00 AM' activeCase:=3588773 newCase:=71463 totalDeaths:=247503 newDeaths:=4102 
#http POST $API_URL timeStamp='5/05/2020, 10:00:00 AM' activeCase:=3517345 newCase:=81454 totalDeaths:=243401 newDeaths:=3797 
#http POST $API_URL timeStamp='5/04/2020, 10:00:00 AM' activeCase:=3435894 newCase:=86108 totalDeaths:=239604 newDeaths:=976 
#http POST $API_URL timeStamp='5/03/2020, 10:00:00 AM' activeCase:=3349786 newCase:=82763 totalDeaths:=238628 newDeaths:=8657 
#http POST $API_URL timeStamp='5/02/2020, 10:00:00 AM' activeCase:=3267184 newCase:=91977 totalDeaths:=229971 newDeaths:=5799 
#http POST $API_URL timeStamp='5/01/2020, 10:00:00 AM' activeCase:=3175207 newCase:=84771 totalDeaths:=224172 newDeaths:=6403 
#http POST $API_URL timeStamp='4/30/2020, 10:00:00 AM' activeCase:=3090445 newCase:=71839 totalDeaths:=217769 newDeaths:=9797 
#http POST $API_URL timeStamp='4/29/2020, 10:00:00 AM' activeCase:=3018681 newCase:=66005 totalDeaths:=207973 newDeaths:=5376 
#http POST $API_URL timeStamp='4/28/2020, 10:00:00 AM' activeCase:=2954222 newCase:=76026 totalDeaths:=202597 newDeaths:=3932 
#http POST $API_URL timeStamp='4/27/2020, 10:00:00 AM' activeCase:=2878196 newCase:=85530 totalDeaths:=198668 newDeaths:=4982 
#http POST $API_URL timeStamp='4/26/2020, 10:00:00 AM' activeCase:=2804796 newCase:=84900 totalDeaths:=193710 newDeaths:=6006 
#http POST $API_URL timeStamp='4/25/2020, 10:00:00 AM' activeCase:=2719897 newCase:=93716 totalDeaths:=187705 newDeaths:=5767 
#http POST $API_URL timeStamp='4/24/2020, 10:00:00 AM' activeCase:=2626321 newCase:=81529 totalDeaths:=181938 newDeaths:=6260 
#http POST $API_URL timeStamp='4/23/2020, 10:00:00 AM' activeCase:=2544792 newCase:=73657 totalDeaths:=175694 newDeaths:=6689 
#http POST $API_URL timeStamp='4/22/2020, 10:00:00 AM' activeCase:=2471136 newCase:=73920 totalDeaths:=169006 newDeaths:=6058 
#http POST $API_URL timeStamp='4/21/2020, 10:00:00 AM' activeCase:=2397216 newCase:=83006 totalDeaths:=162956 newDeaths:=5109 
#http POST $API_URL timeStamp='4/20/2020, 10:00:00 AM' activeCase:=2314621 newCase:=72846 totalDeaths:=157847 newDeaths:=5296 
#http POST $API_URL timeStamp='4/19/2020, 10:00:00 AM' activeCase:=2241359 newCase:=81153 totalDeaths:=152551 newDeaths:=6463 
#http POST $API_URL timeStamp='4/18/2020, 10:00:00 AM' activeCase:=2160207 newCase:=85678 totalDeaths:=146088 newDeaths:=6710 
...
#http POST $API_URL timeStamp='4/12/2020, 10:00:00 AM' activeCase:=1696588 newCase:=85679 totalDeaths:=105952 newDeaths:=6262 
#http POST $API_URL timeStamp='4/11/2020, 10:00:00 AM' activeCase:=1610909 newCase:=89657 totalDeaths:=99690 newDeaths:=6892 
#http POST $API_URL timeStamp='4/10/2020, 10:00:00 AM' activeCase:=1521252 newCase:=85054 totalDeaths:=92798 newDeaths:=7277 
